...
import org.apache.flink.lakesoul.source.LakeSoulDezSourceFunction;
...
public class LakeSoulOracleMultiTableSinkStreamBuilder {
    public static final String ORACLE_SCHEMA_CHANGE_EVENT_KEY_NAME = "io.debezium.connector.oracle.SchemaChangeKey";

    public static final class Context {
        public StreamExecutionEnvironment env;

        public OracleSourceBuild sourceBuilder;

        public Configuration conf;
    }

    private LakeSoulDezSourceFunction<JsonSourceRecord> oraSqlSource;

    private final Context context;

    public LakeSoulOracleMultiTableSinkStreamBuilder(Context context) {
    ...
    public DataStreamSource<JsonSourceRecord> buildMultiTableSource() {
        ...
        oraSqlSource = context.sourceBuilder.build();
        return context.env
                .addSource(this.oraSqlSource,  "Oracle Source")
    ...
    private static class JsonSourceRecordSplitProcessFunction extends ProcessFunction<JsonSourceRecord, JsonSourceRecord> {
        ...
        public void processElement(
            ...
            if (SCHEMA_CHANGE_EVENT_KEY_NAME.equalsIgnoreCase(keySchema.name())||ORACLE_SCHEMA_CHANGE_EVENT_KEY_NAME.equalsIgnoreCase(keySchema.name())) {
